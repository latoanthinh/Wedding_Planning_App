...
const GitfDetail = (props) => {
  ...
  console.log('data:', ChitietGiftData);
  ...
  if (ChitietGiftStatus === 'succeeded') {
    ...
    const formattedPrice = ChitietGiftData?.price?.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' }) || '0 VNĐ';
